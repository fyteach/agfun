...
![Picture from www.montgomerycountymd.gov demonstrating the positioning of a turntable aerial ladder truck](figs/Aerial-Apparatus-Positioning.png)
...
<!-- We call the function $f(x)=\sqrt{x}$ a ***square root function***. As a real-valued function, the domain of the square root function consists of all real numbers $x$ such that $x\ge 0$, in interval notation, the domain is $[0,+\infty)$. -->
...
1. $\sqrt[3]{-8x^3y^6}=\sqrt[3]{(-2xy^2)^2}=-2xy^2$.
