...
## Do You Know How Many People In The Room
...
Equations often contain variable other than the unknowns. Those variables, which are assumed to be known, are usually called ***constants***, ***coefficients*** or ***parameters***. For example, in the linear equation $ax+b=c$ of (the unknown) $x$, the variables $a$, $b$ and $c$ are referred as known coefficients or constants.
...
![](figs/tikz-rectangular-uniform-width.png){width=30%}
...
![](figs/tikz-paint-uniform-width.png){width=30%}
